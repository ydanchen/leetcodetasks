...
public class Solution {
    ...
    /**
     * Returns most common word in the paragraph, but not banned one
     * Functional solution
     *
     * @param paragraph The text to analyze
     * @param banned The array of banned words
     * @return most common word in the paragraph
     */
    public String mostCommonWord(String paragraph, String[] banned) {
        String[] words = paragraph.toLowerCase().split("\\W+");
        List<String> bannedWords = Arrays.asList(banned);
        return String.valueOf(Arrays.stream(words)
